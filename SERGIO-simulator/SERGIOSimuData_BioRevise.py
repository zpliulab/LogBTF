...
sim.build_graph(input_file_taregts ='data_sets/De-noised_100G_9T_300cPerT_4_DS1LLYBioRevised/Interaction_cID_4.txt', 
                input_file_regs='data_sets/De-noised_100G_9T_300cPerT_4_DS1LLYBioRevised/Regs_cID_4_'+str(number_bins)+'type.txt', 
                shared_coop_state=2)
