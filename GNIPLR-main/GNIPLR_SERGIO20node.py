...
os.chdir(str(pathname)+'R/Boolean/'+str(Boolean)+'/DREAM3result_GNIPLR/SERGIOData/')


## list
fileEcoli = [10,20,30,40,50,60]
...
for i in range(np.shape(file)[0]):
    ...
    ax_nl=0.04
    n_d4 = str(dataname)+ str(number_genes)+'_'+str(number_bins)+'_'+str(number_sc)+'.txt'
    ...
    ## Link file
    fw=open('Interaction_cID_4SIGNlist_20node.txt')
