...
setwd(paste("/home/lly/R/Boolean/Data/DREAM3result_ARACNE/Yeast",filenum,"Node",genenum, sep=""))
# setwd(paste("D:/E/博士/R_程序/Boolean/Data/DREAM3result_ARACNE/Yeast",filenum,"Node",genenum, sep=""))
