...
## 2022.11.28 GENIE3 method for single-cell data Ecoli
...
setwd(paste("/home/lly/R/Boolean/Data/DREAM3result_GENIE301/Ecoli",filenum,"Node",genenum, sep=""))
...
## 2022.11.28 GENIE3 method for single-cell data -- Yeast
...
output <- cbind(meanAUCAcc, Result0)
setwd(paste("/home/lly/R/Boolean/Data/DREAM3result_GENIE301/Yeast",filenum,"Node",genenum, sep=""))
...
## 2022.11.28 GENIE3 method for real data5 or data16
