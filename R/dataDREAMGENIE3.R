...
setwd(paste("/home/lly/R/Boolean/Data/DREAM3result_GENIE3/Ecoli",filenum,"Node",genenum, sep=""))
# setwd(paste("D:/E/博士/R_程序/Boolean/Data/DREAM3result_GENIE3/Ecoli",filenum,"Node",genenum, sep=""))
